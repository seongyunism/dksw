            		...
            		<div class="sy-slides-crop">
            			<ul id="slider-aboutUs" class="sy-list">
			                <li class="sy-slide fade useCSS transition sy-active" style="transition-duration: 800ms; opacity: 1;">
			                    <a href="http://bootstrapart.net/dragonfly/v1.5/about-us-v1.php#slide1">
			                ...
			                <li class="sy-slide fade useCSS" style="transition-duration: 800ms; opacity: 0;">
			                    <a href="http://bootstrapart.net/dragonfly/v1.5/about-us-v1.php#slide2">
			                ...
			                <li class="sy-slide fade useCSS transition" style="transition-duration: 800ms; opacity: 0;">
			                    <a href="http://bootstrapart.net/dragonfly/v1.5/about-us-v1.php#slide3">
